...
import com.burakkodaloglu.my_e_commerce_app.databinding.FragmentPaymentBinding
import com.burakkodaloglu.my_e_commerce_app.util.common.viewBinding
import com.burakkodaloglu.my_e_commerce_app.util.extensions.CreditCardTextFormatter
import com.burakkodaloglu.my_e_commerce_app.util.extensions.checkMonthYear
import com.burakkodaloglu.my_e_commerce_app.util.extensions.isNullorEmpty
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            btnPayNow.setOnClickListener {
                ...
                paymentViewModel.clearCart(ClearCart(userId))
            }
        }
    }
